import { Box, Button, Card,Autocomplete,IconButton, CardContent, Chip, Divider, FormControl, Grid, InputLabel, MenuItem, Select, Stack, TextField, Typography, SelectChangeEvent } from "@mui/material";
...
import postEstimation from "../api/products/postEstimation";
   ...
   const navigate = useNavigate()
    ...
    const {data:categories,isLoading:categoriesLoding} = useQuery({
     ...
     const postMutation = useMutation({
      ...
      mutationFn:postEstimation,
      onSuccess:(data:any)=>{
        navigate('/estimation_successfull',{state:{data}})
      },
      onError:()=>{
